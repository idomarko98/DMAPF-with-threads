...
def Main_program():
    ...
    df = add_new_result_to_cvs('empty-8-8.map-1.scen', 'empty-8-8', M, agents[0].incumbentSolutionCost, end - start,
                               counters.Counter_InitMsgs, counters.Counter_NewNodeMsgs, counters.Counter_GoalMsgs,
