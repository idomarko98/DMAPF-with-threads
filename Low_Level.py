    ...
    while openList.empty() == False:
        ...
        if isgoal:
            ...
            for i in range(len(extand_list)):
                possible_extension=Check_if_possible_extension(extand_list[i],dic_close_list,constrains,map) #TODO
            ...
            dic_close_list['state.i,state.j,state.time']=popedSpot #TODO:check
...
new_Spot =Spot(new_state,5,[new_state,new_state1,new_state2])
new_Spot.print_spot()